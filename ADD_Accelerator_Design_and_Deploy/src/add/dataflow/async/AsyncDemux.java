...
/**
 * AsyncDemux component for the UFV asynchronous data flow simulator.<br>
 ...
 * @version 2.0
 */
public class AsyncDemux extends AddGenericRtlibObject {
    ...
    public void constructPorts() {
        ...
        ports = new Port[13];
        ports[0] = getPortClk();
        ports[1] = getPortReqBranch();
        ports[2] = getPortReqLeft0();
        ports[3] = getPortReqRight0();
        ports[4] = getPortReqRight1();
        ports[5] = getPortAckLeft0();
        ports[6] = getPortAckBranch();
        ports[7] = getPortAckRight0();
        ports[8] = getPortAckRight1();
        ports[9] = getPortBranch();
        ports[10] = getPortDin0();
        ports[11] = getPortDout0();
        ports[12] = getPortDout1();
    }
    ...
    public void evaluate(Object arg) {
        ...
        Signal signalReqRight0, signalReqRight1, signalAckBranch;
        ...
        if (hasDisconnectedPorts) {
            ...
            if (clk.hasRisingEdge() && isStart()) {
                ...
                signalReqRight1 = getPortReqRight0().getSignal();
                switch (getFsmOut0()) {
                    case IDLE:
                        if (isDataReadyIn0() != isDataReadyOut0() && isBranchReady() != isDataReadyOut0() && valueAckRight0.is_0()) {
                            ...
                            switch (getControlIn0()) {
                                case DONE:
                                    ...
                                    getSimulator().scheduleEvent(SimEvent1164.createNewSimEvent(signalReqRight1, time, nextReqR0, getPortReqRight0()));
                ...
                switch (getFsmOut1()) {
                    case IDLE:
                        if (isDataReadyIn0() != isDataReadyOut1() && isBranchReady() != isDataReadyOut1() && valueAckRight1.is_0()) {
                ...
                switch (getFsmBranch()) {
                    case IDLE:
                        if (isBranchReady() == isDataReadyOut0() && isBranchReady() == isDataReadyOut1() && valueReqBranch.is_1()) {
    ...
    public void setWidth(String s) {
        ...
        try {
            ...
            if (isConnected() && n != getWidth()) {
                JOptionPane.showMessageDialog(null, "Demux.setWidth: The component bus size can not be changed "
            ...
            switch (n) {
                ...
                case 32:
                    break;
                default:
                    JOptionPane.showMessageDialog(null, "Demux.setWidth: illegal argument\nusing a width of 16 bits instead!",
                            "Warning", JOptionPane.WARNING_MESSAGE);
                    n = 16; // default width
            }
        } catch (HeadlessException | NumberFormatException e) {
            JOptionPane.showMessageDialog(null, "Demux.setWidth: illegal argument" + e
