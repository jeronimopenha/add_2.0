...
/**
 * AsyncGenericUn component for the UFV asynchronous data flow simulator.<br>
 ...
 * @version 2.0
 */
public class AsyncGenericUn extends AddGenericRtlibObject {
    ...
    public void constructPorts() {
        ...
        setPortReqRight0(new PortStdLogic1164(this, "reqr0", Port.OUT, null));
        setPortAckLeft0(new PortStdLogic1164(this, "ackl0", Port.OUT, null));
        setPortAckRight0(new PortStdLogic1164(this, "ackr0", Port.IN, null));
