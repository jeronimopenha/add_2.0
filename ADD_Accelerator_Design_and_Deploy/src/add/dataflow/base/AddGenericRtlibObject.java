 ...
 * @version 2.0
 */
public class AddGenericRtlibObject
        extends AddSimObject
     ...
     *
     * This method inializes the basic AddSimObject with our Port arrays, the
   ...
   * HEX-formatted String of the output vector's value.
    ...
    /*public SimObject copy() {
        AddGenericRtlibObject tmp = null;
        try {
            tmp = (AddGenericRtlibObject) this.getClass().newInstance();
