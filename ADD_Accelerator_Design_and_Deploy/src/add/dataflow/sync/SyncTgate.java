...
/**
 * SyncTgate component for the UFV synchronous data flow simulator.<br>
 ...
 * @version 2.0
 */
public class SyncTgate extends SyncGenericUn {
    ...
    public void constructPorts() {
        ...
        setPortBIn(new PortStdLogicVector(this, "bin", Port.IN, null, BRANCH_VECTOR_WIDTH));
    ...
    public void evaluate(Object arg) {
        ...
        Signal signalDin0, signalDout0, signalBIn;
