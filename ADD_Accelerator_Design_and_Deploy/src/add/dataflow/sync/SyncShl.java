...
/**
 * SyncShl component for the UFV synchronous data flow simulator.<br>
 ...
 * @version 2.0
 */
public class SyncShl extends SyncGenericBin {
     ...
     * the bits of the first parameter to the left N times, where N is equal to
