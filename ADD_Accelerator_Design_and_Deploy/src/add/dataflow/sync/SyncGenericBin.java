...
/**
 * SyncGenericBin component for the UFV synchronous data flow simulator.<br>
 ...
 * @version 2.0
 */
public class SyncGenericBin extends AddGenericRtlibObject {
    ...
    public AddSimObject copy() {
        ...
        try {
            ...
            message("-E- Internal error in SyncGenericBin.copy(): " + e);
    ...
    public void reset(double time) {
        ...
        if ((signalDout0 = getPortDout0().getSignal()) != null) {
            StdLogicVector dOut = new StdLogicVector(getRealWidth(), 0);
    ...
    public void evaluate(Object arg) {
        ...
        if (hasDisconnectedPorts) {
            ...
            if (clk.hasRisingEdge() && isStart()) {
                ...
                StdLogicVector dIn1 = (StdLogicVector) signalDin0.getValue();
                StdLogicVector dIn2 = (StdLogicVector) signalDin1.getValue();

                dataCtrl ctrl;
                if (getCtrl(dIn1.getValue()) == dataCtrl.DONE || getCtrl(dIn2.getValue()) == dataCtrl.DONE) {
                    ctrl = dataCtrl.DONE;
                } else if (getCtrl(dIn1.getValue()) == dataCtrl.STOP || getCtrl(dIn2.getValue()) == dataCtrl.STOP) {
                    ctrl = dataCtrl.STOP;
                } else {
                    ctrl = getCtrl(dIn1.getValue());
                }
                ...
                switch (ctrl) {
                    ...
                    case STOP:
                        ...
                        break;
                    case VALID:
                        long result = compute(getData(dIn1.getValue()), getData(dIn2.getValue()));
    ...
    public void setWidth(String s) {
        ...
        try {
            ...
            if (isConnected() && n != getWidth()) {
                JOptionPane.showMessageDialog(null, "GenericBin.setWidth: The component bus size can not be changed "
            ...
            switch (n) {
                ...
                case 32:
                    break;
                default:
                    JOptionPane.showMessageDialog(null, "GenericBin.setWidth: illegal argument!",
                            "Warning", JOptionPane.WARNING_MESSAGE);
                    n = this.n_bits - 2; // default width
            }
        } catch (HeadlessException | NumberFormatException e) {
            JOptionPane.showMessageDialog(null, "GenericBin.setWidth: illegal argument" + e,
